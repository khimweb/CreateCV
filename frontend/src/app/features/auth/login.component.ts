      ...
      <div class="auth-layout">
        ...
        <main class="auth-card">
          ...
          <form [formGroup]="form" (ngSubmit)="submit()">
            ...
            <label>Password<input formControlName="password" type="password" placeholder="••••••••" autocomplete="current-password" /></label>
...
export class LoginComponent {
  form: FormGroup; error = signal<string | null>(null); returnUrl = signal<string>('/');
