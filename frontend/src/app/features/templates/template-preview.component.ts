              ...
              >
                @if (t.layout === 'modern-split') {
                  ...
                  <app-abbey-creative-cv
                    ...
                    [experience]="[
                      { company: 'SOFT DESIGN STUDIOS', position: 'GRAPHIC DESIGNER', startDate: '2015', endDate: '2017', description: 'Porttitor amet massa Done cporttitor dolor et nisl molestie ium feliscon lore ipsum dolor tfringilla lorem lorem ipsum ollicitudin est dolor time.' },
                      { company: 'WEB TECH LTD', position: 'WEB DESIGNER', startDate: '2013', endDate: '2015', description: 'Porttitor amet massa Done cporttitor dolor et nisl molestie ium feliscon lore ipsum dolor tfringilla lorem lorem ipsum ollicitudin est dolor time.' },
                      { company: 'DEV CREATIVE SOLUTIONS', position: 'LEAD WEB DESIGNER', startDate: '2010', endDate: '2013', description: 'Porttitor amet massa Done cporttitor dolor et nisl molestie ium feliscon lore ipsum dolor tfringilla lorem lorem ipsum ollicitudin est dolor time.' }
                    ]"
                    [education]="[
                      { institution: 'UNIVERSITY OF LOREM', degree: 'CERTIFICATE OF WEB TRAINIG', startYear: '2008', endYear: '2010', description: 'Porttitor amet massa Done cporttitor dolor et nisl molestie ium feliscon lore ipsum dolor tfringilla lorem lorem ipsum.' },
                      { institution: 'UNIVERSITY OF LOREM', degree: 'BECHELOR OF ART DIRECTOR', startYear: '2007', endYear: '2009', description: 'Porttitor amet massa Done cporttitor dolor et nisl molestie ium feliscon lore ipsum dolor tfringilla lorem lorem ipsum.' },
                      { institution: 'UNIVERSITY OF LOREM', degree: 'BECHELOR OF ART DIRECTOR', startYear: '2007', endYear: '2009', description: 'Porttitor amet massa Done cporttitor dolor et nisl molestie ium feliscon lore ipsum dolor tfringilla lorem lorem ipsum.' }
                    ]"
                    [references]="[
                      { name: 'WILLIAM KLEIMAN', position: 'Director', company: 'Matrix media limited', phone: '+555 123 5566', email: 'williamkleiman@gmail.com' },
                      { name: 'JENSEN SMITH', position: 'Web developer', company: 'Design mate LTD', phone: '+123 5556 4455', email: 'jensonsmith@gmail.com' }
                    ]"
                    [skills]="[
...
export class TemplatePreviewComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.http.get<{ template: any }>(`/api/v1/templates/${id}`).subscribe(({ template }) => {
      ...
      const layout: CvTemplate['layout'] = name.includes('abbey')
        ? 'abbey-creative'
