...
export class TranslationService {
  ...
  private dictionary: Translations = {
    ...
    navEditImage: { en: 'Edit Image', kh: 'កែរូបថត / ប្តូរអាវធំ' },
    ...
    // Edit Image & AI Suit Studio
    editImageBadge: { en: 'AI Studio Portrait & Suit Generator', kh: 'បច្ចេកវិទ្យា AI ប្តូរអាវធំ & កែរូបថតអាជីព' },
    editImageTitle: { en: 'Transform Casual Photos into', kh: 'ប្តូររូបថតធម្មតាទៅជា' },
    editImageTitleAccent: { en: 'Professional Studio Portraits', kh: 'រូបថតអាជីពពាក់អាវធំកម្រិតស្ទូឌីយោ' },
    editImageSubtitle: {
      en: 'Upload your student, casual, or phone photo and instantly generate a high-end corporate suit & tie portrait ready for CVs, job applications, and passports.',
      kh: 'បញ្ចូលរូបថតទូរស័ព្ទ ឬឯកសណ្ឋានសាមញ្ញរបស់អ្នក ដើម្បីប្តូរទៅជារូបថតពាក់អាវធំចងក្រវ៉ាត់កកម្រិតស្ទូឌីយោ សម្រាប់ដាក់ CV ការងារ ឬលិខិតឆ្លងដែនភ្លាមៗ។'
    },
    editImageUploadTitle: { en: 'Upload Your Portrait Photo', kh: 'បញ្ចូលរូបថតរបស់អ្នក' },
    editImageUploadSub: { en: 'Drag and drop JPG, PNG, or WebP (max 15MB)', kh: 'ទម្លាក់រូបភាព JPG, PNG ឬ WebP (ទំហំអតិបរមា 15MB)' },
    editImageTrySample: { en: 'Try Demo Sample', kh: 'សាកល្បងរូបគំរូ' },
    editImageStep1: { en: '1. Select Formal Outfit (អាវធំ)', kh: '១. ជ្រើសរើសម៉ូដអាវធំ' },
    editImageStep2: { en: '2. Studio Backdrop Color', kh: '២. ជ្រើសរើសផ្ទៃខាងក្រោយ' },
    editImageBtnGenerate: { en: 'Generate Professional Photo', kh: 'ដំណើរការបង្កើតរូបថតអាជីព' },
    editImageBtnGenerating: { en: 'Processing with AI Studio...', kh: 'កំពុងកែសម្រួលរូបថតតាម AI...' },
    editImageBefore: { en: 'Original Input Photo', kh: 'រូបភាពដើម' },
    editImageAfter: { en: 'AI Professional Retouch', kh: 'រូបភាពកែរួចដោយ AI' },
    editImageBtnDownload: { en: 'Download HD Photo', kh: 'ទាញយករូបថតកម្រិតច្បាស់ (HD)' },
    editImageBtnUseInCv: { en: 'Use in My CV', kh: 'ប្រើប្រាស់ក្នុង CV ខ្ញុំ' },
    editImageBtnReset: { en: 'Edit Another Photo', kh: 'កែរូបថតថ្មី' },
    editImageSuccessMsg: { en: 'Portrait successfully transformed with professional suit!', kh: 'បានកែសម្រួលរូបថតពាក់អាវធំអាជីពដោយជោគជ័យ!' },
    editImageComparing: { en: 'Drag slider to compare Before & After', kh: 'អូសដើម្បីប្រៀបធៀបរូបភាព មុន និង ក្រោយ' },
    editImageCategoryMan: { en: "Men's Suits (អាវធំបុរស)", kh: 'អាវធំបុរស' },
    editImageCategoryWoman: { en: "Women's Suits (អាវធំនារី)", kh: 'អាវធំនារី' },
    editImageComingSoon: { en: 'Coming Soon', kh: 'ឆាប់ៗនេះ' },
    editImageCustomColor: { en: 'Custom Color', kh: 'ពណ៌តាមចិត្ត' },
    editImageSuit1: { en: 'Black Suit & Dotted Tie', kh: 'អាវធំខ្មៅ & ក្រវ៉ាត់កអុច' },
    editImageSuit2: { en: 'Black Suit & Silver Silk Tie', kh: 'អាវធំខ្មៅ & ក្រវ៉ាត់កប្រាក់' },
    editImageSuit3: { en: 'Black Suit & Yellow-Blue Striped Tie', kh: 'អាវធំខ្មៅ & ក្រវ៉ាត់កឆ្នូតលឿងខៀវ' },
    editImageSuit4: { en: 'Navy Suit & Blue-White Striped Tie', kh: 'អាវធំខៀវ & ក្រវ៉ាត់កឆ្នូត' },
    editImageSuit5: { en: 'Dark Navy Suit & Royal Blue Tie', kh: 'អាវធំខៀវចាស់ & ក្រវ៉ាត់កខៀវ' },
    editImageBgWhite: { en: 'Pure White (CV/Passport)', kh: 'ពណ៌ស (ស្តង់ដារ CV/Passport)' },
    editImageBgBlue: { en: 'Studio Blue (ID/Academic)', kh: 'ពណ៌ខៀវ (អត្តសញ្ញាណប័ណ្ណ/សាលា)' },
    editImageBgRed: { en: 'Official Red', kh: 'ពណ៌ក្រហមផ្លូវការ' },
    editImageBgGrey: { en: 'Corporate Grey', kh: 'ពណ៌ប្រផេះ' },
    editImageAdjustTitle: { en: 'Fine-tune Head Position & Fit', kh: 'កែតម្រូវទីតាំងក្បាល និងទំហំ' },
    editImageZoom: { en: 'Zoom / Scale', kh: 'ពង្រីក / បង្រួម' },
    editImageMoveY: { en: 'Move Up / Down', kh: 'រំកិល ឡើង / ចុះ' },
    editImageMoveX: { en: 'Move Left / Right', kh: 'រំកិល ឆ្វេង / ស្តាំ' },
    editImageResetPos: { en: 'Reset Alignment', kh: 'កំណត់ឡើងវិញ' },
  };
